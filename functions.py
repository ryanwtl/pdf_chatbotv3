...
def query_document2(vectorstore, query, api_key, model_name="Llama3"):
    ...
    url = "https://api.openai.com/v1/chat/completions"  # Replace with the API endpoint you are using
    headers = {
    ...
    # Map model names to their respective GroqCloud API models
    # model_mapping = {
    ...
    structured_response_df = pd.DataFrame([answer_row, source_row, reasoning_row], 
                                          columns=['answer', 'source', 'reasoning'], 
